                    ...
                    <tr>
                        ...
                        <td class="project_progress text-center">
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-green" role="progressbar" aria-valuenow="{{ $package->getUsagePercentage() }}"
                                    aria-valuemin="0" aria-valuemax="100" style="width: {{ $package->getUsagePercentage() }}%">
                                </div>
                            </div>
                            <small>
                                {{ $package->getUsagePercentage() }}% Complete
                            </small>
                        </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="createPackageForm" enctype="multipart/form-data">
                        ...
                        <!-- Max Admins field -->
                        <div class="form-group">
                            <label for="max_admins">Max Admins</label>
                            <input type="number" class="form-control" id="max_admins" name="max_admins" required>
                        </div>

                        <!-- Max Teachers field -->
                        <div class="form-group">
                            <label for="max_teachers">Max Teachers</label>
                            <input type="number" class="form-control" id="max_teachers" name="max_teachers" required>
                        </div>

                        <!-- Max Classes field -->
                        <div class="form-group">
                            <label for="max_classes">Max Classes</label>
                            <input type="number" class="form-control" id="max_classes" name="max_classes" required>
                        </div>
            ...
            <div class="modal-body">
                ...
                <form id="editPackageForm" data-package-id="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="edit_max_students" name="max_students" required>
                    </div>

                    <!-- Max Admins field -->
                    <div class="form-group">
                        <label for="edit_max_admins">Max Admins</label>
                        <input type="number" class="form-control" id="edit_max_admins" name="max_admins" required>
                    </div>

                    <!-- Max Teachers field -->
                    <div class="form-group">
                        <label for="edit_max_teachers">Max Teachers</label>
                        <input type="number" class="form-control" id="edit_max_teachers" name="max_teachers" required>
                    </div>

                    <!-- Max Classes field -->
                    <div class="form-group">
                        <label for="edit_max_classes">Max Classes</label>
                        <input type="number" class="form-control" id="edit_max_classes" name="max_classes" required>
                    </div>
...
<script>
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var newRow = '<tr>' +
                        ...
                        '<td>' + response.max_students + '</td>' +
                        '<td>' + response.max_teachers + '</td>' +
                        '<td>' + response.max_admins + '</td>' +
                        '<td>' + response.max_classes + '</td>' +
        ...
        $(document).on('click', '.edit-package-btn', function () {
            ...
            $('#editPackageForm input[name="max_students"]').val(package.max_students);
            $('#editPackageForm input[name="max_admins"]').val(package.max_admins);
            $('#editPackageForm input[name="max_teachers"]').val(package.max_teachers);
            $('#editPackageForm input[name="max_classes"]').val(package.max_classes);
        ...
        $('#editPackageForm').submit(function (e) {
            ...
            var formData = new FormData(this);
            var packageId = $(this).data('package-id');
            var url = '/packages/' + packageId + '/edit';
            var csrfToken = $('meta[name="csrf-token"]').attr('content');
