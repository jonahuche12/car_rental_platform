...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h5>School Activation</h5> <b></b></div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="#">
                            ...
                            <small class="text-success">₦ {{number_format($price, 2)}}</small><br>
                    ...
                    <div id="bankTransferSection" style="display: none;" class="alert alert-success">
                        <div class="mb-4 p-3 bg-light rounded">
                            ...
                            <p class='text-sm'><b>Total Amount:</b>₦ {{number_format($price, 2)}}</p>
                        ...
                        <form id="confirmBankTransferForm" method="POST" action="{{ route('confirm_transfer') }}">
                            ...
                            <input type="hidden" name="amount_input" id="amount" class="form-control" value="{{$price}}" required>
                            <input type="hidden" name="id_paid_for" id="id_paid_for" class="form-control" value="{{ $school_id }}" required>
                            <input type="hidden" name="paid_for" id="paid_for" class="form-control" value="school_activation" required>
...
$('#confirmBankTransferForm').submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                console.log(response.transfer.email)
