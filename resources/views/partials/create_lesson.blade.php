...
<form id="lessonForm" class="lesson-form" action="{{ route('upload') }}" enctype="multipart/form-data">
    ...
    <div id="videoFields">
        <small><span class="file-info text-black" id="span-info" style="color:#fff"><b>Upload Video (Max duration: 10 mins)</b></span></small>
        ...
        <span class="text-dark"><small>Add video</small></span>
        ...
        <!-- Continue button -->
        <div class="btn-group" role="group" aria-label="Lesson Form Buttons" style="display: flex; align-items: center;">
            <button type="button" class="btn btn-primary" id="continue-btn" disabled>Continue</button>
            <button type="button" id="replaceVideoButton" class="btn btn-secondary btn-sm" style="display: none; margin-left: 10px;" onclick="replaceVideo()">
                <i class="fas fa-sync"></i> <!-- Replace icon -->
            </button>
        </div>
    </div>
    <!-- Other form fields -->
    <div id="otherFormFields" style="display: none;">
        <input type="hidden" name="lesson_id" id="lesson_id" class="form-control">
        <div class="form-group">
            <label for="lessonSubject" class="text-dark">Subject</label>
        ...
        <div class="form-group">
            <label for="lessonSubject" class="text-dark">Class</label>
            ...
            <span class="file-info text-dark"><small>Select Best class for this lesson</small></span>
        </div>
        <div class="form-group">
            <label for="lessonDescription" class="text-dark">Description</label>
            <textarea class="form-control" id="lessonDescription" name="description"></textarea>
        </div>
        <div class="form-group">
            <label for="lessonThumbnail" class="file-label text-dark">
