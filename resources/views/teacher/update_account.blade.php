...
<div class="update-container">
    <div class="content">
        ...
        <form id="updateTeacherAccountForm" action="{{ route('withdrawal.saveUserAccount', ['token' => $withdrawalRequest->token]) }}" method="POST">
            @csrf
...
<script>
    $(document).ready(function() {
        $('#updateTeacherAccountForm').submit(function(e) {
