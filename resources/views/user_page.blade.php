...
@section('title')
@if(isset($user))
CSS - {{$user->profile->full_name}} - User Page
@else
...
@section('content')
<?php
$userpage = "users_page/userpage";
$userRole = $user->profile->role ?? null;

if ($userRole == "school_owner") {
    $userpage = "users_page/school_owner_userpage";
}elseif ($userRole == "teacher") {
    $userpage = "users_page/teacher_userpage";
}elseif ($userRole == "student") {
    $userpage = "users_page/student_userpage";
}elseif ($userRole == "staff") {
    $userpage = "users_page/staff_userpage";
}elseif ($userRole == "guardian") {
    $userpage = "users_page/guardian_userpage";
}elseif ($userRole == "super_admin") {
    $userpage = "users_page/super_admin_userpage";
}elseif ($userRole == "admin") {
    $userpage = "users_page/admin_userpage";
}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var totalLessonsLink = document.getElementById('totalLessonsLink');
        totalLessonsLink.addEventListener('click', function (event) {
            event.preventDefault();
            document.querySelector('.nav-pills .nav-link[href="#lessons"]').click();
        });
    });
</script>
<script>
...
$(document).ready(function() {
    ...
    function createLessonHtml(item) {
        ...
        html += '<a class="lesson-link" href="/lessons/' + item.id + '" data-lesson-id="' + item.id + '" data-lesson-title="' + item.title + '" data-school-connects-required="' + item.school_connects_required + '">';
